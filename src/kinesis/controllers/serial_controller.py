...
class SerialController(ABC):
    ...
    """
    def __init__(self, name, port, device_type, step_increase_label, step_decrease_label):
        ...
        self.step_increase_label = step_increase_label
        self.step_decrease_label = step_decrease_label
